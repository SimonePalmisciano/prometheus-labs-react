        ...
        <div className="container py-4">
            ...
            <div className="main-wrapper">
                <div className="row flex-column g-4">
                    {cartItems.map((item) => (
                        <div className="col-xs-12 col-lg-8" key={item.slug}>
                            <CartItemCard item={item} />
                        </div>
                    ))}
                </div>
                {cartItems.length > 0 && (
                    <div className="col-xs-12 col-lg-8 mb-4 card p-3 bg-white">
                ...
                <div className="py-5">
                    <Link to="/checkout"
                        ...
                        <button className='clearCartBtn' disabled={isCartEmpty}>Checkout</button>
                    </Link>
                </div>
            </div>
